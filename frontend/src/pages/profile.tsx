	...
	return (
      ...
      <Flex mb={6} maxWidth="900px" justify="flex-start" direction="column">
        ...
        <p>
          ...
          voluptatem error dolores nemo pariatur quae tempora est adipisci
          reprehenderit nulla at impedit veritatis debitis molestiae reiciendis,
          consectetur blanditiis incidunt! Eum?
        </p>
      </Flex>
      ...
      <Flex mb={6} maxWidth="900px" justify="flex-start" direction="column">
        ...
        <p>
          ...
          ipsam, ex, voluptas veniam eveniet eligendi exercitationem ea omnis
          maiores ad amet alias voluptatem dolore sint optio odit esse voluptate
          tempore!
        </p>
      </Flex>
